      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled photo">
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_1.jpg')?>);"></a></li>
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_2.jpg')?>);"></a></li>
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_3.jpg')?>);"></a></li>
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_4.jpg')?>);"></a></li>
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_5.jpg')?>);"></a></li>
            <li><a href="#" class="img" style="background-image: url(<?php echo get_theme_file_uri('images/image_6.jpg')?>);"></a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
