  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="http://dev-chongjing.pantheonsite.io/"><span class="img" style="background-image: url(<?php echo get_theme_file_uri('images/author.jpg')?>);"></span>Louie Smith</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="http://dev-chongjing.pantheonsite.io/">Home</a></li>
					<li><a href="http://dev-chongjing.pantheonsite.io/collection/">Collection</a></li>
					<li><a href="http://dev-chongjing.pantheonsite.io/about-me/">About Me</a></li>
					<li><a href="http://dev-chongjing.pantheonsite.io/my-services/">My Services</a></li>
					<li><a href="http://dev-chongjing.pantheonsite.io/blog/">Blog</a></li>
					<li><a href="http://dev-chongjing.pantheonsite.io/contact/">Contact</a></li>
				</ul>
			</nav>
